const Footer = ({ hidden }: { hidden: boolean }) => {
  return (
    <footer className={`${hidden ? 'hidden' : ''} text-center text-white dark:bg-neutral-600`}>
      <div className="container  pt-9">
        <div className="mb-9 flex justify-center">
          <a className="cursor-pointer mr-9 text-neutral-800 dark:text-neutral-200">
            <svg
          ...
          <a className="cursor-pointer text-neutral-800 dark:text-neutral-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
